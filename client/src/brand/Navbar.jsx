...
function Navbar() {
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto me-5 mb-2 mb-lg-0">
            <li className="nav-item">
              <NavLink className="nav-link" exact to="/brand/home" activeClassName="active">Search Creators</NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link" to="/brand/profile" activeClassName="active">My Profile</NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link" to="/brand/chat" activeClassName="active">Chat</NavLink>
            </li>
  ...
  <li><a className="dropdown-item" style={{color:'black'}} href={apiUrl+'/api/brand/auth/logout'}>Logout</a></li>
</ul>
