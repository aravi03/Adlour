  ...
  const [success, setSuccess] = useState('');
    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await fetch(apiUrl+'/api/user/auth/signup', {
            method: 'POST',
            headers: {
  ...
  <div class="d-flex align-items-center" style={{height:'70%'}}>
      <div class="row gx-lg-5 align-items-center">
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          Connecting you with the world's top brands for exciting sponsorship opportunities. Showcase your unique content, grow your audience, and collaborate with leading brands to create impactful campaigns. Join our community of creators today and start unlocking new possibilities for your content.
          </p>
        </div>
        ...
        <Button style={{backgroundColor:'var(--accent-color)',color:'white'}} variant="dark" type="submit" className="mt-4">
          Register
              ...
              <br></br>
              Already have an account? You can <a href='/creator/login'>Login</a>              
                </div>
      </Form>
            </div>
          </div>
